...
namespace CodeMonkey.Utils {
    ...
    public static class UtilsClass {
        ...
        public static FunctionUpdater CreateWorldTextUpdater(Func<string> GetTextFunc, Vector3 localPosition, Transform parent = null, int fontSize = 40, Color? color = null, TextAlignmentOptions textAlignment = TextAlignmentOptions.Left, int sortingOrder = sortingOrderDefault) {
            TextMeshPro textMesh = CreateWorldText(GetTextFunc(), parent, localPosition, fontSize, color, textAlignment, sortingOrder);
        ...
        public static TextMeshPro CreateWorldText(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, TextAlignmentOptions textAlignment, int sortingOrder) {
            ...
            Transform transform = gameObject.transform;
            transform.SetParent(parent, false);
            transform.localPosition = localPosition + Vector3.up * 0.1f;
            ...
            textMesh.rectTransform.pivot = new Vector2(0, 0);
        ...
        public static void CreateWorldTextPopup(Transform parent, string text, Vector3 localPosition, int fontSize, Color color, Vector3 finalPopupPosition, float popupTime) {
            TextMeshPro textMesh = CreateWorldText(parent, text, localPosition, fontSize, color, TextAlignmentOptions.Left, sortingOrderDefault);
